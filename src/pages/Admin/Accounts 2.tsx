...
const accountTabs: Array<{
...
}> = [
  {
    ...
    label: "Users",
    description:
      "All registered users, account status, and enforcement actions.",
  },
  {
    key: "active-coaches",
    label: "Active Coaches",
    description:
      "Current coaches, prices, certifications, and contract counts.",
  },
];
    ...
    <div>
      <div className="justify-between items-center px-38 py-4 bg-white shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
        ...
        <p className="mt-2 text-[13.125px] leading-6">
          Review platform accounts, manage suspension and deactivation flows,
          and inspect the active coach roster from one shared page.
        </p>
      </div>
              ...
              {accountTabs.map((tab) => {
                ...
                return (
                  <Button
                    ...
                    className={
                      isActive ? "bg-[#5B5EF4] font-semibold" : "bg-[#5B5EF4]"
                    }
                  >
                    {tab.label}
                  </Button>
