                ...
                <Modal.Container>
                    <Modal.Dialog className="rounded-lg">
                        ...
                        <Modal.Header>
                            ...
                            <p className="text-gray-400 text-sm">This action cannot be undone. Your account and all data will be permanently deleted.</p>
                            <div className="flex w-full justify-end gap-2">
                                <Button className="rounded-lg bg-white text-black border border-black">Cancel</Button>
                                <Button className="rounded-lg bg-[#E5484D] text-white" onClick={deleteHandler}>Delete</Button>
                            </div>
                        </Modal.Header>
                    </Modal.Dialog>
                </Modal.Container>
