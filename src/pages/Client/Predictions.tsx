...
import { getWalletSummary } from "../../services/Predictions/predictionWalletService";
...
export default function Predictions() {
  const [activeTab, setActiveTab] =
    useState<PredictionPageTabKey>("gambling-den");
            ...
            <Card className="border border-amber-200 bg-amber-50 shadow-sm">
              <div className="flex items-start gap-3 p-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[13.125px] text-amber-800">
                    {pageError}
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                  ...
                  <p className="mt-2 max-w-3xl text-[13.125px] leading-6 text-foreground/65">
                    Browse bettable markets in Gambling Den, track your
                    participation in My Bets, manage creator workflows in My
                    Markets, and monitor ranking in Leaderboard.
                  </p>
                </div>
