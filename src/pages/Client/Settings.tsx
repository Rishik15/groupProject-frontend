                ...
                <div className="w-full flex justify-center">
                    <Tabs className="w-full">
                        <Tabs.ListContainer>
                            ...
                            >
                                <Tabs.Tab id="overview" className="font-normal rounded-full px-2 py-2 text-sm font-medium text-black whitespace-nowrap">
                                    Info
                                    <Tabs.Indicator />
                                </Tabs.Tab>

                                <Tabs.Tab id="analytics" className="font-normal rounded-full px-3 py-2 text-sm font-medium text-black whitespace-nowrap">
                                    Progress Photos
                                    <Tabs.Indicator />
                                </Tabs.Tab>

                                <Tabs.Tab id="reports" className="font-normal rounded-full px-2 py-2 text-sm font-medium text-black whitespace-nowrap">
                                    Settings
                                    <Tabs.Indicator />
                                </Tabs.Tab>
                            </Tabs.List>
                                ...
                                <div className="overflow-hidden rounded-[28px] border border-[#d9dbe3] bg-white">
                                    <Button className="w-full h-[50px] px-6 flex items-center justify-between bg-transparent hover:bg-[#f9fafb] border-b border-[#e5e7eb] rounded-none">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-base font-normal text-black">Messages</span>
                                        </div>
                                    ...
                                    <Button className="w-full h-[50px] px-6 flex items-center justify-between bg-transparent hover:bg-[#f9fafb] border-b border-[#e5e7eb] rounded-none">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-base font-normal text-black">Browse Coaches</span>
                                        </div>
                                        <ChevronRight className="w-5 h-5 text-gray-400" />
                                    </Button>
                                    ...
                                    <Button className="w-full h-[50px] px-6 flex items-center justify-between bg-transparent hover:bg-[#f9fafb] border-b border-[#e5e7eb] rounded-none">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-base font-normal text-black">Payments & Billing</span>
                                        </div>
                                        <ChevronRight className="w-5 h-5 text-gray-400" />
                                    </Button>
                                    ...
                                    <Button className="w-full h-[50px] px-6 flex items-center justify-between bg-transparent hover:bg-[#f9fafb] border-b border-[#e5e7eb] rounded-none">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-base font-normal text-black">Notifications</span>
                                        </div>
                                        <ChevronRight className="w-5 h-5 text-gray-400" />
                                    </Button>
                                    ...
                                    <Button className="w-full h-[50px] px-6 flex items-center justify-between bg-transparent hover:bg-[#f9fafb] rounded-none">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-base font-normal text-black">Help & Support</span>
                                        </div>
                                        <ChevronRight className="w-5 h-5 text-gray-400" />
                                    </Button>
                                </div>
