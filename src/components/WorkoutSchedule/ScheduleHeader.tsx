    ...
    return (
        <>
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <h2 className="text-[18.75px] font-semibold text-[#0F0F14]">Weekly Schedule</h2>
                    <p className="mt-1 text-[11.25px] text-[#72728A]">
                        Drag local sessions by day and hour, edit blocks in place, and log a workout
                        directly from any session card.
                    </p>
                </div>
