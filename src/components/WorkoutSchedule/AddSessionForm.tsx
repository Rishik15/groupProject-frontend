    ...
    return (
      <div className="rounded-2xl border border-[#E5E7EB] bg-white px-4 py-4">
        ...
        <p className="mt-1 font-primary text-[12px] leading-5 text-[#72728A]">
          Choose a recommended workout plan or create your own plan before
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Button
            ...
            className="h-9 rounded-xl border border-indigo-100 bg-white px-4 font-primary text-[12px] font-semibold text-indigo-500"
          >
            Recommendations
          </Button>
          ...
          <Button
            ...
            className="h-9 rounded-xl border-0 bg-indigo-500 px-4 font-primary text-[12px] font-semibold text-white"
          >
            Create Plan
          </Button>
        </div>
