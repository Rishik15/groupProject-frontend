  ...
  if (error) {
    return (
      <Card className="rounded-3xl border border-rose-200 bg-rose-50 p-6">
        <h3 className="text-[18.75px] font-semibold text-rose-800">
          Unable to load your markets
        </h3>
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-2">
            ...
            <h2 className="text-[18.75px] font-semibold text-slate-900">
              Manage the markets you created
            </h2>
            <p className="max-w-3xl text-[13.125px] text-slate-500">
              Review market lifecycle, close eligible markets, and send
              cancellation requests when necessary.
            </p>
          </div>
