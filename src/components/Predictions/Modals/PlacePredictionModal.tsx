    ...
    <Modal>
      ...
      >
        <Modal.Container placement="center" size="md" scroll="inside">
          <Modal.Dialog
            aria-label="Place prediction bet"
          ...
          >
            <Modal.Header className="flex items-start justify-between gap-4 border-b border-slate-100 px-6 py-5">
              <div className="space-y-1">
                ...
                <h2 className="text-[13.125px] font-semibold text-slate-900">
                  {market?.title ?? "Place a bet"}
                </h2>
                <p className="text-[13.125px] text-slate-500">
                  {market?.goal_text ?? "Choose a side and confirm your wager."}
                </p>
              </div>
            </Modal.Header>
            ...
            <Modal.Body className="space-y-5 px-6 py-6">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-[13.125px] font-semibold capitalize text-slate-900">
                          {side}
                        </span>
                        {active && (
                          <CheckCircle2 className="h-4 w-4 text-[#5B5EF4]" />
                        )}
                      </div>
              ...
              <div className="space-y-2">
                <label
                  htmlFor="prediction-points-wagered"
                ...
                />
                <p className="text-[13.125px] text-slate-500">
                  Available balance: {walletBalance} points
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-[13.125px] text-slate-600">
                ...
                <div className="mt-2 flex items-center justify-between">
                  ...
                  <span className="font-medium text-slate-900">
                    {Number.isFinite(numericWager) ? numericWager : 0}
                  </span>
                </div>
                <p className="mt-3 text-[11.25px] text-slate-500">
                  Final payout calculations remain backend-driven. This modal
                  focuses on the finalized MVP bet payload.
                </p>
              </div>
