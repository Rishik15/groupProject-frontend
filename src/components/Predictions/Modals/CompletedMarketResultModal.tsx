...
function getResultValue(market?: PredictionMarket | null) {
  ...
  return (
    ...
    (market.status === "cancelled" ? "cancelled" : null)
  );
}
...
function getResultMeta(result: ReturnType<typeof getResultValue>) {
  ...
  return {
    ...
    description:
      "This market was cancelled and should be treated as a refunded / void outcome.",
    icon: Flag,
          ...
          <Modal.Dialog className="max-w-3xl rounded-3xl border border-default-200 bg-background shadow-2xl">
            <Modal.Header className="border-b border-default-200 px-6 py-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h2 className="text-[18.75px] font-semibold tracking-tight text-foreground">
                    Completed market result
                  </h2>
                  <p className="mt-1 text-[13.125px] text-foreground/60">
                    Finalized market outcome, settlement context, and pool
                    summary.
                  </p>
                </div>
              </div>
              ...
              {!market ? (
                <Card className="border border-dashed border-default-300 bg-content2/40 p-6 text-center shadow-none">
                  <p className="text-[13.125px] text-foreground/60">
                    No completed market is currently selected.
                  </p>
                </Card>
              ) : (
                <>
                    ...
                    <div className="space-y-5 p-6">
                      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        <div>
                          ...
                          <p className="mt-2 max-w-2xl text-[13.125px] leading-7 text-foreground/65">
                            {market.goal_text}
                          </p>
                        </div>

                        <div
                          className={`inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-semibold ${resultMeta.tone}`}
                        >
                          <ResultIcon
                            className={`h-4 w-4 ${resultMeta.iconTone}`}
                            strokeWidth={2.2}
                          />
                          {resultMeta.label}
                        </div>
                      ...
                      <div className="space-y-4 p-5">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="rounded-2xl bg-content2/50 p-4">
                            ...
                            <p className="mt-2 text-[18.75px] font-semibold text-foreground">
                              {formatPoints(market.total_bets)}
                            </p>
                          </div>
                          ...
                          <div className="rounded-2xl bg-content2/50 p-4">
                            ...
                            <p className="mt-2 text-[18.75px] font-semibold text-foreground">
                              {formatPoints(market.total_points)}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4 p-5">
                        ...
                        <div className="space-y-3">
                          <div className="rounded-2xl bg-content2/50 p-4">
                            ...
                            <p className="mt-2 text-[13.125px] font-semibold text-foreground">
                    ...
                    <div className="space-y-4 p-5">
                      ...
                      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                        <div className="rounded-2xl bg-content2/50 p-4">
                          ...
                          <p className="mt-2 text-[13.125px] font-semibold capitalize text-foreground">
                            {market.status}
                          </p>
                        </div>
