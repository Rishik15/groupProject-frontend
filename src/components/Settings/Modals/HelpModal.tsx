        ...
        <Modal.Container>
          <Modal.Dialog className="sm:max-w-[570px]">
            <Modal.Header>
              <div>
                <Modal.CloseTrigger />
                <Modal.Heading className="text-2xl font-extrabold mb-3">
                  Help & Support
                </Modal.Heading>
                <p className="text-sm text-gray-500">
                  Need something? Pick an option below and we'll route you to
                  the right place.
                </p>
              </div>
            </Modal.Header>
            ...
            <Modal.Footer>
              <Button
                ...
                className="rounded-xl bg-white text-black border border-gray-300"
              >
                Close
              </Button>
            </Modal.Footer>
