  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-default-900">Coach applications</h2>
          <p className="mt-1 text-sm text-default-600">
            Review applicants by status, search their profile details, and use the
            side panel to approve or reject a selected application.
          </p>
        </div>
      ...
      <p className="text-sm text-default-500">
        {visibleCount} of {totalCount} application{totalCount === 1 ? "" : "s"} shown.
      </p>
    </div>
  );
};
